...
export const ACTIVITIES: Activity[] = [
  {
    ...
    location: { neighborhood: 'East Side', city: 'Portland', venueName: 'Cedar Ridge Trailhead' },
  ...
  },
  {
    ...
    location: { neighborhood: 'Hawthorne', city: 'Portland' },
  ...
  },
  {
    ...
    location: { neighborhood: 'Alberta Arts District', city: 'Portland', venueName: 'Studio Commons' },
  ...
  },
  {
    ...
    category: 'games',
    emoji: '🎲',
    host: { name: 'Portland Board Gamers', avatar: 'PB', verified: true },
    location: { neighborhood: 'Pearl District', city: 'Portland', venueName: 'Café Noir' },
  ...
  },
  {
    ...
    location: { neighborhood: 'Sellwood', city: 'Portland', venueName: 'Sellwood Public Library' },
  ...
  },
  {
    ...
    location: { neighborhood: 'St. Johns', city: 'Portland', venueName: 'St. Johns Community Center' },
  ...
  },
  {
    ...
    location: { neighborhood: 'Downtown', city: 'Portland', venueName: 'Tom McCall Waterfront Park' },
    dateLabel: 'Tomorrow',
    time: '6:45 AM',
    spotsTotal: 25,
    spotsLeft: 12,
  ...
  },
  {
    ...
    location: { neighborhood: 'Division', city: 'Portland' },
    dateLabel: 'Sat Mar 22',
    time: '5:00 PM',
    spotsTotal: 6,
    spotsLeft: 1,
  ...
  },
  {
    ...
    location: { neighborhood: 'North Portland', city: 'Portland', venueName: 'Rose City Courts' },
